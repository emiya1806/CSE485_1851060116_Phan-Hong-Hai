...
INSERT INTO `aboutus_setup` (`id`, `shortdesc`, `heading`, `subheading`, `longdesc`, `website`, `dob`) VALUES ('1', 'Hello My name is Phan Hai', 'Student', 'Studying Thuy Loi University', 'My favourite sport is Chess, Swimming. During my free time, I read book or play game with my friend', '', '18 June 2000');
...
(1, 'Phan Hai', 'emiya1806@gmail.com', 'admin', 1);
...
(1, 'Phan Hai', 'i am a student, I make website and php web portals .', 'Information Technology Student', 'icons8-computer-support-64.png');
...
(7, 'e', '1st - 9th Grade', '2006 - 2015', 'NGuyen Dinh Chieu School', ''),
(8, 'e', '10th - 12th Grade', '2015 - 2018', 'HUS high school for gifted student', 'it was fun'),
(9, 'pe', 'Information Tecnology', '2020 - Present', 'Thuy Loi University', '');
...
(1, 'Birthday', '18 June,2000'),
(2, 'Age', '20'),
(3, 'Website', ''),
(4, 'Degree', 'Bachelors Degree'),
(5, 'Mobile', '+849342000'),
(6, 'Email', 'emiya1806@gmail.com'),
(7, 'City', 'Ha Noi');
